...
public class WeatherAPI {
    static ArrayList<Weather> mweather = new ArrayList<>();


        public static void main(String[] args) throws IOException {
            StringBuilder urlBuilder = new StringBuilder("http://know.nifos.go.kr/openapi/mtweather/mountListSearch.do"); /*URL*/
            urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=GTV1ptFOh2KvJM4BZTc0ErxkmooB2x0qUj1TPfXFsfg%3D"); /*Service Key*/
